...
import pandas as pd
import pickle
from scripts.PEC_functions import predict, control, explain
...
# load data
with open('../data_merged/imported_clean_data.pickle', 'rb') as f:
...
for participant_id in participants.participant_id.unique():
    ...
    trials_with_PEC_mm[participant_id] = {"trials_vis": trials_vis_new,
                                          ...
                                          "task": task,
                                          "MM": mm}
    with open("../outputs/trials_with_PEC_mm.pickle", "wb") as f:
