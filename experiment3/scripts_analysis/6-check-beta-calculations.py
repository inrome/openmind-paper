...
participants_accuracy = trials.groupby(['participant_id', 'test_condition', 'trial_type', 'test_order'])['response_correct_mm'].mean().reset_index()
participants_accuracy = participants_accuracy.rename(columns = {'test_condition': 'task', 'response_correct_mm': 'accuracy'})

# add AN data
participants_accuracy_an = trials.groupby(['participant_id', 'test_condition', 'trial_type', 'test_order'])['response_correct_mm_an'].mean().reset_index()
...
participants = pd.merge(participants_betas, participants_accuracy, on = ['participant_id', 'task', 'trial_type', 'test_order'])
