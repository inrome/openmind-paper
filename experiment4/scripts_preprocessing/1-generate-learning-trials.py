...
# participant_id = 1 # for testing purposes REMOVE THIS LINE

for participant_id in participant_ids:
    # get full trials data for participant
    participant_data = trials.loc[(trials['participant_id'] == participant_id)]
    ...
    ts_learning_1 = ts_learning_raw[['participant_id', 'fsm_number', "test_condition", "transfer_order", "transfer_task_1", "transfer_task_2",
    ...
    if len(ts_learning_1['learning_counter']) > 16:
    ...
    ts_learning_2 = ts_learning_raw[['participant_id', 'learning_counter', 'sender', 'response', 'duration', 'test_condition', "transfer_order", "transfer_task_1", "transfer_task_2"]].copy()
    ...
    # remove participants with unusual number of learning trials
    if len(ts_learning_1) != 16: 
